...
Why append-only JSONL: a single locked writer means concurrent sessions never clobber each other's rows, the streams stay greppable and machine-readable, and a bad-line-tolerant reader survives a stray hand-edit. Your history stays trustworthy forever.
